                ...
                <form action="{{ url('Search-Result') }}" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-1 col-sm-2">
                            <div class="form-group no-margin">
                                <div class="search-location">
                                    <select class="selectpicker" data-live-search="false" data-live-search-style="begins" name="city" >
                        ...
                        <div class="col-md-1 col-sm-2">
                            <div class="form-group no-margin">
                                <div class="search-location">
                                    <select name="purpose" class="selectpicker " data-live-search="false" data-live-search-style="begins">
                        ...
                        <div class="col-md-4 col-sm-7">
                            <div class="row">
                                <div class="col-sm-4 col-xs-12">
                                    <select name="subtype" class="selectpicker" data-live-search="false" data-live-search-style="begins">
                      ...
                      <div class="row">
                            <div class="col-sm-3 col-xs-6">
                                <div class="form-group">
                                    <select class="selectpicker" data-live-search="true" data-live-search-style="begins" name="OwnerShipStatus" title="Owner Ship">
