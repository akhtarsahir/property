        ...
        <div class="header-left">
                    ...
                    @if($server[0] != 'justdeal')
                        <a href="{{ Config::get('app.url') }}">
                            @if(empty($companyprofile->company_logo))
                                <img src="{{ asset('public/ProfileImage/90x90_'.$companyprofile->image )  }}" alt="{{ $companyprofile->first_name.' '.$companyprofile->last_name }}" style="height: 90px;" >
                            @else
                                <img src="{{ asset('public/CompanyImage/90x90_'.$companyprofile->company_logo )  }}" alt="{{ $companyprofile->first_name.' '.$companyprofile->last_name }}" style="height: 90px;" >
                            @endif
                        </a>
                    @else
                        <a href="{{ Config::get('app.url') }}">
            ...
            <nav class="navi main-nav">
                <ul>
                    ...
                    <nav class="navi main-nav">
                        <ul>
                            <li><a href="">{{ $Agent->company_name }}</a></li>
                        </ul>
                    </nav>
                    @endif
        </div>
