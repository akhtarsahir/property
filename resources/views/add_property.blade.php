                            ...
                            <div class="col-sm-12">
                                <div class="form-group ">
                                    ...
                                    <div class="col-sm-3">
                                        ...
                                        <select  id="city_address"class="selectpicker"name="city" data-live-search="false" dat-live-search-style="begins" title="Select" required>
                                            <!--<option id="place-name"></option>-->
                                            @foreach($city as $city)
                                            <option class="{{ $city->latitude }},{{ $city->longitude }}" value="{{ $city->name }}">{{ $city->city }}</option>
                                            @endforeach
