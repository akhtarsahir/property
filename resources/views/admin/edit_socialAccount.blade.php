                ...
                <div class="panel panel-info">
                    ...
                    <div class="panel-body">
                        <form action="{{ URL::action('SocialAccountController@update',['id' => $record]) }}" method="post"  class="form-horizontal">
                            ...
                            <div class="form-group">
                                <label class="col-md-2 control-label"> Web sit email </label>
                                <div class="col-md-8">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <input type="text" name="contact_no" value="{{$record->contact_no}}" placeholder="Enter contact_no" class="form-control" required>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <input type="text" name="address" value="{{$record->address}}" placeholder="Enter address" class="form-control" required>
                                </div>
                            </div>
                            <div class="form-group">
