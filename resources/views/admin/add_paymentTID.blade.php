        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form action="/admin/add_paymentTIDStore/" method="post" enctype="multipart/form-data" name="myform" id="form-id">
                        {!! csrf_field() !!}
                        <input id="id" type="hidden" name="id" value="{{ Auth::user()->id }}">
                        @foreach($orders as $pro)
                         <input id="id" type="hidden" name="order_id" value="{{$pro->id}}">
                         <input id="id" type="hidden" name="property_id" value="{{$pro->property_id}}">
                        <div class="form-group">
                            <div class="col-md-3">
                                <label class="control-label">Order No</label>
                            </div>
                            <div class="col-md-3">
                                <input type="text" readonly class="form-control" value="{{$pro->order_id}}" name="order_no" >
                            </div>
                             <div class="col-md-2">
...
<script>
    ...
    if (confirm("Thank you for your payment!\nPlease Wait for your verification and activation for your ad.\n you can check your payment status form click OK Button otherwise cancel")){
       document.forms['form-id'].action='/admin/clickhere_store/';
