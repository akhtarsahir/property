                                    ...
                                    <div class="panel panel-info">
                                        ...
                                        <div class="panel-body border">
                                            <form action="/admin/update_property" method="post" enctype="multipart/form-data" class="form-horizontal form-bordered">
                                                ...
                                                <div class="form-group  @if($property->type = 'projects' ) hide @endif">
                                                ...
                                                <div class="form-group striped-col">
                                                    ...
                                                    <div class="col-md-9">
                                                        <div class="col-md-6 @if($property->type = 'projects' ) hide @endif">
                                                        ...
                                                        <div class="col-md-6 @if($property->type = 'projects' ) hide @endif">
                                                            ...
                                                            <input type="text" id="example-disabled"  name="ConstructedArea" value="{{ $property->ConstructedArea }}" class="form-control" placeholder="Enter Constructed Area" >
                                                        </div>
                                                        <div class="col-md-6 @if($property->type = 'projects' ) hide @endif">
                                                            <label class="" for="example-select">Open Area</label>
                                                            <input type="text" id="example-disabled"  name="OpenArea" value="{{ $property->OpenArea }}" class="form-control" placeholder="Enter Open Area" >
                                                        </div>
                                                        <div class="col-md-6 @if($property->type = 'projects' ) hide @endif">
                                                            <label class="" for="example-select">Construction Year</label>
                                                            <input type="date" id="example-disabled" name="ConstructionYear" value="{{ $property->ConstructionYear }}" class="form-control" placeholder="Enter Construction Year" >
                                                        </div>
                                                        <div class="col-md-6 @if($property->type = 'projects' ) hide @endif">
...
<!--                                                <div class="form-group">
                                                ...
                                                $property->subtype == 'Houses / Villas'
                                                    ...
                                                    <div class="col-md-9">
                                                        ...
                                                        <div class="col-sm-6">
                                                            ...
                                                            <input class="form-control outline" id="floor" name="floor" value="{{ $property->floor }}" placeholder="Enter Number of Floor ">
                                                ...
                                                <div id="projects" class="projects @if($property->type != 'projects' ) hide @endif ">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-9">
                                                                        ...
                                                                        <label for="Title" class="col-sm-2 bold-class">PropertyType</label>
                                                                        ...
                                                                        <div class="controled">
                                                                                     <div class="col-sm-4" style="padding: 0 2px 0 0;">
                                                                                          <input type="text" class="form-control" id="title" name="title0" value="{{ $property->title0 }}" placeholder="Enter Property title">
                                                                                                    <label class=" alert-danger hide" id="title_error"> Please Enter title </label>
                                                                                      </div>
                                                                                     <div class="col-sm-2"style="padding: 0 2px 0 0;">
                                                                                                    <select class="form-control"  data-live-search="false" data-live-search-style="begins" title="Select" tabindex="-98" id="property_type" name="property_type0">
                                                                                                        <option value="{{ $property->property_type0 }}">{{ $property->property_type0 }}</option>
                                                                                     ...
                                                                                     <div class="col-sm-2" style="padding: 0 2px 0 0;">
                                                                                                    <input type="text" class="form-control" id="price" name="price0" value="{{ $property->price0 }}" placeholder="Enter price">
                                                                                                    <label class=" alert-danger hide" id="price_error"> Please Enter price </label>
                                                                                               </div>
                                                                                     <div class="col-sm-1" style="padding: 0 2px 0 0;">
                                                                                           <input type="text" class="form-control" id="beds" name="beds0" value="{{ $property->beds0 }}" placeholder="Enter beds">
                                                                                          <label class=" alert-danger hide" id="beds_error"> Please Enter beds </label>
                                                                                        </div>
                                                                                     <div class="col-sm-1" style="padding: 0 2px 0 0;">
                                                                                                    <input type="text" class="form-control" id="bath" name="bath0" value="{{ $property->bath0 }}" placeholder="Enter Property bath">
                                                                                                    <label class=" alert-danger hide" id="bath_error"> Please Enter bath </label>
                                                                                                </div>
                                                                                     <div class="col-sm-2" style="padding: 0 2px 0 0;">
                                                                                                   <input type="text" class="form-control" id="property_size" name="property_size0" value="{{ $property->property_size0 }}" placeholder="Enter property_size">
                                                                                                    <label class=" alert-danger hide" id="property_size_error"> Please Enter property_size </label>
                                                                                               </div>
                                                                          </div>
                                                              <div class="controled">
                                                                                     <div class="col-sm-4" style="padding: 0 2px 0 0;">
                                                                                          <input type="text" class="form-control" id="title" name="title1" value="{{ $property->title1 }}" placeholder="Enter Property title">
                                                                                                    <label class=" alert-danger hide" id="title_error"> Please Enter title </label>
                                                                                      </div>
                                                                                     <div class="col-sm-2" style="padding: 0 2px 0 0;">
                                                                                                    <select class="form-control"  data-live-search="false" data-live-search-style="begins" title="Select" tabindex="-98" id="property_type" name="property_type1">
                                                                                                        <option class="bs-title-option" value="{{ $property->property_type1 }}">{{ $property->property_type1}}</option>
                                                                                                       <option value="Residential">Residential</option>
                                                                                                       <option value="Commercial">Commercial</option>
                                                                                                    </select>
                                                                                                    <label class=" alert-danger hide" id="property_type_error"> Please Enter property_type </label>
                                                                                     ...
                                                                                     <div class="col-sm-2" style="padding: 0 2px 0 0;">
                                                                                                    <input type="text" class="form-control" id="price" name="price1" value="{{ $property->price1 }}" placeholder="Enter price">
                                                                                                    <label class=" alert-danger hide" id="price_error"> Please Enter price </label>
                                                                                               </div>
                                                                                     <div class="col-sm-1" style="padding: 0 2px 0 0;">
                                                                                           <input type="text" class="form-control" id="beds" name="beds1" value="{{ $property->beds1 }}" placeholder="Enter beds">
                                                                                          <label class=" alert-danger hide" id="beds_error"> Please Enter beds </label>
                                                                                        </div>
                                                                                     <div class="col-sm-1" style="padding: 0 2px 0 0;">
                                                                                                    <input type="text" class="form-control" id="bath" name="bath1" value="{{ $property->bath1 }}" placeholder="Enter Property bath">
                                                                                                    <label class=" alert-danger hide" id="bath_error"> Please Enter bath </label>
                                                                                                </div>
                                                                                     <div class="col-sm-2" style="padding: 0 2px 0 0;">
                                                                                                   <input type="text" class="form-control" id="property_size" name="property_size1" value="{{ $property->property_size1 }}" placeholder="Enter property_size">
                                                                                                    <label class=" alert-danger hide" id="property_size_error"> Please Enter property_size </label>
                                                                                               </div>
                                                                          </div>
                                                              <div class="controled">
                                                                                     <div class="col-sm-4" style="padding: 0 2px 0 0;">
                                                                                          <input type="text" class="form-control" id="title" name="title2" value="{{ $property->title2 }}" placeholder="Enter Property title">
                                                                                                    <label class=" alert-danger hide" id="title_error"> Please Enter title </label>
                                                                                      </div>
                                                                                     <div class="col-sm-2"style="padding: 0 2px 0 0;">
                                                                                                    <select class="form-control"  data-live-search="false" data-live-search-style="begins" title="Select" tabindex="-98" id="property_type" name="property_type2">
                                                                                                        <option class="bs-title-option" value="{{ $property->property_type2 }}">{{ $property->property_type2 }}</option>
                                                                                                       <option value="Residential">Residential</option>
                                                                                                       <option value="Commercial">Commercial</option>
                                                                                                    </select>
                                                                                                    <label class=" alert-danger hide" id="property_type_error"> Please Enter property_type </label>
                                                                                     ...
                                                                                     <div class="col-sm-2" style="padding: 0 2px 0 0;">
                                                                                                    <input type="text" class="form-control" id="price" name="price2" value="{{ $property->price2 }}" placeholder="Enter price">
                                                                                                    <label class=" alert-danger hide" id="price_error"> Please Enter price </label>
                                                                                               </div>
                                                                                     <div class="col-sm-1" style="padding: 0 2px 0 0;">
                                                                                           <input type="text" class="form-control" id="beds" name="beds2" value="{{ $property->beds2 }}" placeholder="Enter beds">
                                                                                          <label class=" alert-danger hide" id="beds_error"> Please Enter beds </label>
                                                                                        </div>
                                                                                     <div class="col-sm-1" style="padding: 0 2px 0 0;">
                                                                                                    <input type="text" class="form-control" id="bath" name="bath2" value="{{ $property->bath2 }}" placeholder="Enter Property bath">
                                                                                                    <label class=" alert-danger hide" id="bath_error"> Please Enter bath </label>
                                                                                                </div>
                                                                                     <div class="col-sm-2"style="padding: 0 2px 0 0;">
                                                                                                   <input type="text" class="form-control" id="property_size" name="property_size2" value="{{ $property->property_size2 }}" placeholder="Enter property_size">
                                                                                                    <label class=" alert-danger hide" id="property_size_error"> Please Enter property_size </label>
                                                                                               </div>
                                                                          </div>
                                                              <div class="controled">
                                                                                     <div class="col-sm-4"style="padding: 0 2px 0 0;">
                                                                                          <input type="text" class="form-control" id="title" name="title3" value="{{ $property->title3 }}" placeholder="Enter Property title">
                                                                                                    <label class=" alert-danger hide" id="title_error"> Please Enter title </label>
                                                                                      </div>
                                                                                     <div class="col-sm-2" style="padding: 0 2px 0 0;">
                                                                                                    <select class="form-control"  data-live-search="false" data-live-search-style="begins" title="Select" tabindex="-98" id="property_type" name="property_type3">
                                                                                                        <option class="bs-title-option" value="{{ $property->property_type3 }}">{{ $property->property_type3 }}</option>
                                                                                                        <option value="Residential">Residential</option>
                                                                                                        <option value="Commercial">Commercial</option>
                                                                                                    </select>
                                                                                                    <label class=" alert-danger hide" id="property_type_error"> Please Enter property_type </label>
                                                                                     ...
                                                                                     <div class="col-sm-2" style="padding: 0 2px 0 0;">
                                                                                                    <input type="text" class="form-control" id="price" name="price3" value="{{ $property->price3 }}" placeholder="Enter price">
                                                                                                    <label class=" alert-danger hide" id="price_error"> Please Enter price </label>
                                                                                               </div>
                                                                                     <div class="col-sm-1" style="padding: 0 2px 0 0;">
                                                                                           <input type="text" class="form-control" id="beds" name="beds3" value="{{ $property->beds3 }}" placeholder="Enter beds">
                                                                                          <label class=" alert-danger hide" id="beds_error"> Please Enter beds </label>
                                                                                        </div>
                                                                                     <div class="col-sm-1" style="padding: 0 2px 0 0;">
                                                                                                    <input type="text" class="form-control" id="bath" name="bath3" value="{{ $property->bath3 }}" placeholder="Enter Property bath">
                                                                                                    <label class=" alert-danger hide" id="bath_error"> Please Enter bath </label>
                                                                                                </div>
                                                                                     <div class="col-sm-2" style="padding: 0 2px 0 0;">
                                                                                                   <input type="text" class="form-control" id="property_size" name="property_size3" value="{{ $property->property_size3 }}" placeholder="Enter property_size">
                                                                                                    <label class=" alert-danger hide" id="property_size_error"> Please Enter property_size </label>
                                                                                               </div>
                                                                          </div>
                                                              <div class="controled">
                                                                                     <div class="col-sm-4"style="padding: 0 2px 0 0;">
                                                                                          <input type="text" class="form-control" id="title" name="title4" value="{{ $property->title4 }}" placeholder="Enter Property title">
                                                                                                    <label class=" alert-danger hide" id="title_error"> Please Enter title </label>
                                                                                      </div>
                                                                                     <div class="col-sm-2" style="padding: 0 2px 0 0;">
                                                                                                    <select class="form-control"  data-live-search="false" data-live-search-style="begins" title="Select" tabindex="-98" id="property_type" name="property_type4">
                                                                                                        <option class="bs-title-option" value="{{ $property->property_type4 }}">{{ $property->property_type4 }}</option>
                                                                                                        <option value="Residential">Residential</option>
                                                                                                        <option value="Commercial">Commercial</option>
                                                                                                    </select>
                                                                                                    <label class=" alert-danger hide" id="property_type_error"> Please Enter property_type </label>
                                                                                     ...
                                                                                     <div class="col-sm-2"style="padding: 0 2px 0 0;">
                                                                                                    <input type="text" class="form-control" id="price" name="price4" value="{{ $property->price4 }}" placeholder="Enter price">
                                                                                                    <label class=" alert-danger hide" id="price_error"> Please Enter price </label>
                                                                                               </div>
                                                                                     <div class="col-sm-1" style="padding: 0 2px 0 0;">
                                                                                           <input type="text" class="form-control" id="beds" name="beds4" value="{{ $property->beds4 }}" placeholder="Enter beds">
                                                                                          <label class=" alert-danger hide" id="beds_error"> Please Enter beds </label>
                                                                                        </div>
                                                                                     <div class="col-sm-1" style="padding: 0 2px 0 0;">
                                                                                                    <input type="text" class="form-control" id="bath" name="bath4" value="{{ $property->bath4 }}" placeholder="Enter Property bath">
                                                                                                    <label class=" alert-danger hide" id="bath_error"> Please Enter bath </label>
                                                                                                </div>
                                                                                     <div class="col-sm-2" style="padding: 0 2px 0 0;">
                                                                                                   <input type="text" class="form-control" id="property_size" name="property_size4" value="{{ $property->property_size4 }}" placeholder="Enter property_size">
                                                                                                    <label class=" alert-danger hide" id="property_size_error"> Please Enter property_size </label>
                                                                                               </div>
                                                                          </div>
                                                              <div class="controled">
                                                                                     <div class="col-sm-4" style="padding: 0 2px 0 0;">
                                                                                          <input type="text" class="form-control" id="title" name="title5" value="{{ $property->title4 }}" placeholder="Enter Property title">
                                                                                                    <label class=" alert-danger hide" id="title_error"> Please Enter title </label>
                                                                                      </div>
                                                                                     <div class="col-sm-2" style="padding: 0 2px 0 0;">
                                                                                                    <select class="form-control"  data-live-search="false" data-live-search-style="begins" title="Select" tabindex="-98" id="property_type" name="property_type5">
                                                                                                        <option class="bs-title-option" value="{{ $property->property_type5 }}">{{ $property->property_type5 }}</option>
                                                                                                        <option value="Residential">Residential</option>
                                                                                                        <option value="Commercial">Commercial</option>
                                                                                                    </select>
                                                                                                    <label class=" alert-danger hide" id="property_type_error"> Please Enter property_type </label>
                                                                                     ...
                                                                                     <div class="col-sm-2" style="padding: 0 2px 0 0;">
                                                                                                    <input type="text" class="form-control" id="price" name="price5" value="{{ $property->price5 }}" placeholder="Enter price">
                                                                                                    <label class=" alert-danger hide" id="price_error"> Please Enter price </label>
                                                                                               </div>
                                                                                     <div class="col-sm-1" style="padding: 0 2px 0 0;">
                                                                                           <input type="text" class="form-control" id="beds" name="beds5" value="{{ $property->beds5 }}" placeholder="Enter beds">
                                                                                          <label class=" alert-danger hide" id="beds_error"> Please Enter beds </label>
                                                                                        </div>
                                                                                     <div class="col-sm-1" style="padding: 0 2px 0 0;">
                                                                                                    <input type="text" class="form-control" id="bath" name="bath5" value="{{ $property->bath5 }}" placeholder="Enter Property bath">
                                                                                                    <label class=" alert-danger hide" id="bath_error"> Please Enter bath </label>
                                                                                                </div>
                                                                                     <div class="col-sm-2" style="padding: 0 2px 0 0;">
                                                                                                   <input type="text" class="form-control" id="property_size" name="property_size5" value="{{ $property->property_size5 }}" placeholder="Enter property_size">
                                                                                                    <label class=" alert-danger hide" id="property_size_error"> Please Enter property_size </label>
                                                                                               </div>
                                                                          </div>
                                                              <div class="controled">
                                                                                     <div class="col-sm-4" style="padding: 0 2px 0 0;">
                                                                                          <input type="text" class="form-control" id="title" name="title6" value="{{ $property->title6 }}" placeholder="Enter Property title">
                                                                                                    <label class=" alert-danger hide" id="title_error"> Please Enter title </label>
                                                                                      </div>
                                                                                     <div class="col-sm-2" style="padding: 0 2px 0 0;">
                                                                                                    <select class="form-control"  data-live-search="false" data-live-search-style="begins" title="Select" tabindex="-98" id="property_type" name="property_type6">
                                                                                                        <option class="bs-title-option" value="{{ $property->property_type6 }}">{{ $property->property_type6 }}</option>
                                                                                                        <option value="Residential">Residential</option>
                                                                                                        <option value="Commercial">Commercial</option>
                                                                                                    </select>
                                                                                                    <label class=" alert-danger hide" id="property_type_error"> Please Enter property_type </label>
                                                                                     ...
                                                                                     <div class="col-sm-2"style="padding: 0 2px 0 0;">
                                                                                                    <input type="text" class="form-control" id="price" name="price6" value="{{ $property->price6 }}" placeholder="Enter price">
                                                                                                    <label class=" alert-danger hide" id="price_error"> Please Enter price </label>
                                                                                               </div>
                                                                                     <div class="col-sm-1" style="padding: 0 2px 0 0;">
                                                                                           <input type="text" class="form-control" id="beds" name="beds6" value="{{ $property->beds6 }}" placeholder="Enter beds">
                                                                                          <label class=" alert-danger hide" id="beds_error"> Please Enter beds </label>
                                                                                        </div>
                                                                                     <div class="col-sm-1" style="padding: 0 2px 0 0;">
                                                                                                    <input type="text" class="form-control" id="bath" name="bath6" value="{{ $property->bath6 }}" placeholder="Enter Property bath">
                                                                                                    <label class=" alert-danger hide" id="bath_error"> Please Enter bath </label>
                                                                                                </div>
                                                                                     <div class="col-sm-2" style="padding: 0 2px 0 0;">
                                                                                                   <input type="text" class="form-control" id="property_size" name="property_size6" value="{{ $property->property_size6 }}" placeholder="Enter property_size">
                                                                                                    <label class=" alert-danger hide" id="property_size_error"> Please Enter property_size </label>
                                                                                               </div>
                                                                          </div>
                                                           </div>
                                            ...
                                            <div class="form-group">
                                                    <label class="col-md-3 control-label" for="example-select">Maps & Payment Plans</label>
                                                    <div class="col-md-9">

                                                        <div class="col-md-2">
                                                            <label class="" for="example-select">Image 1</label>
                                                            <img src="{{ asset('public/propertypaymentPlansImage/'.$property->id.'/100x75'.$property->paymentPlansImage0)  }}" alt="{{ $property->title }}">
                                                        </div>
                                                        @if($property->paymentPlansImage1 != '')
                                                            <div class="col-md-2">
                                                                <label class="" for="example-select">Image 2</label>
                                                                <img src="{{ asset('public/propertypaymentPlansImage/'.$property->id.'/100x75'.$property->paymentPlansImage1)  }}" alt="{{ $property->title }}">
                                                            </div>
                                                        @endif
                                                        @if($property->paymentPlansImage2 != '')
                                                            <div class="col-md-2">
                                                                <label class="" for="example-select">Image 3</label>
                                                                <img src="{{ asset('public/propertypaymentPlansImage/'.$property->id.'/100x75'.$property->paymentPlansImage2)  }}" alt="{{ $property->title }}">
                                                            </div>
                                                        @endif
                                                        @if($property->paymentPlansImage3 != '')
                                                            <div class="col-md-2">
                                                                <label class="" for="example-select">Image 4</label>
                                                                <img src="{{ asset('public/propertypaymentPlansImage/'.$property->id.'/100x75'.$property->paymentPlansImage3)  }}" alt="{{ $property->title }}">
                                                            </div>
                                                        @endif
                                                        @if($property->paymentPlansImage4 != '')
                                                            <div class="col-md-2">
                                                                <label class="" for="example-select">Image 5</label>
                                                                <img src="{{ asset('public/propertypaymentPlansImage/'.$property->id.'/100x75'.$property->paymentPlansImage4)  }}" alt="{{ $property->title }}">
                                                            </div>
                                                        @endif
                                                ...
                                                <div class="form-group striped-col">
                                                    <label class="col-md-3 control-label" for="example-select">Change Maps & Payment Plans</label>
                                                    <div class="col-md-9">

                                                        <div class="col-md-4">
                                                            <label class="" for="example-select">Image 1</label>
                                                            <input type="hidden" name="old_paymentPlansImage0" value="{{ $property->paymentPlansImage0 }}" >
                                                            <input type="file" id="example-file-input" name="new_paymentPlansImage0" accept="image/x-png,image/gif,image/jpeg">
                                                        </div>
                                                        <div class="col-md-4">
                                                            <label class="" for="example-select">Image 2</label>
                                                            <input type="hidden" name="old_paymentPlansImage1" value="{{ $property->paymentPlansImage1 }}" >
                                                            <input type="file" id="example-file-input" name="new_paymentPlansImage1" accept="image/x-png,image/gif,image/jpeg">
                                                        </div>
                                                        <div class="col-md-4">
                                                            <label class="" for="example-select">Image 3</label>
                                                            <input type="hidden" name="old_paymentPlansImage2" value="{{ $property->paymentPlansImage2 }}" >
                                                            <input type="file" id="example-file-input" name="new_paymentPlansImage2" accept="image/x-png,image/gif,image/jpeg">
                                                        </div>
                                                        <div class="col-md-4">
                                                            <label class="" for="example-select">Image 4</label>
                                                            <input type="hidden" name="old_paymentPlansImage3" value="{{ $property->paymentPlansImage3 }}" >
                                                            <input type="file" id="example-file-input" name="new_paymentPlansImage3" accept="image/x-png,image/gif,image/jpeg">
                                                        </div>
                                                        <div class="col-md-4">
                                                            <label class="" for="example-select">Image 5</label>
                                                            <input type="hidden" name="old_paymentPlansImage4" value="{{ $property->paymentPlansImage4 }}" >
                                                            <input type="file" id="example-file-input" name="new_paymentPlansImage4" accept="image/x-png,image/gif,image/jpeg">
                                                        </div>
                                             ...
                                             @if( Auth::user()->BusinessType == '2')
                                                <div class="form-group striped-col">
                                                    <label class="col-md-3 control-label" for="example-select">Select Agent </label>
                                                    <div class="col-md-9">

                                                        <div class="col-md-4">
                                                           
                                                                   <select id="agent_id" name="agent_id" class="form-control" size="1">
