        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form action="/admin/update_paymentmethod/" method="post" enctype="multipart/form-data" name="myform">
                        {!! csrf_field() !!}
...
<!--                             <div class="col-md-3">
                                <select class="form-control" name="method_name">
                                    <option value="Bank" @if($payment->method_name == 'Bank') selected @endif > Bank </option>
                                    <option value="JazzCash" @if($payment->method_name == 'JazzCash') selected @endif > Jazz Cash </option>
                                    <option value="EasyPaisa" @if($payment->method_name == 'EasyPaisa') selected @endif >Easy Paisa</option>
                                </select>
                            ...
                            <div class="col-md-6">
                                <input type="text" class="form-control" value="{{$payment->method_name}}" name="method_name" >
                            </div>
                        </div>
                        <br><br>
                        <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <div class='box well well-sm' >
                                            ...
                                            <div class='box-body pad'>
                                                <textarea class="textarea editor-cls form-control" placeholder="Place some text here" value=""rows="10" id="description_acount" name="description_acount" >{{$payment->description_acount}}</textarea>
                                            </div>
                                        </div>
                        ...
                        <div class="form-group">
                            <div class="col-md-6 col-md-offset-3">
                                <button type="submit" class="btn btn-success">
                                    <i class="glyphicon glyphicon-file"></i> Update Payment Method
                                </button>
                            </div>
                        </div>
                        <br>
