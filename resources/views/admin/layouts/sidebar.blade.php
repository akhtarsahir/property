            ...
            <ul id="menu" class="page-sidebar-menu">
                ...
                <li>
                    <a href="#">
                        ...
                        <span class="title">Free Listing</span>
                ...
                <li>
                    <a href="#">
                        ...
                        <span class="title">Featured Listing</span>
                        <span class="fa arrow"></span>
                    </a>
                    <ul class="sub-menu">
                        <li>
                            <a href="{{ url('admin/Orders_List') }}">
                                <i class="fa fa-angle-double-right"></i>
                                Order Feature Listing
                            </a>
                            <a href="{{ url('admin/Orders_paymentList') }}">
                                <i class="fa fa-angle-double-right"></i>
                                Order Payment List
                            </a>
                             @if( Auth::user()->type == 'admin')
                            <a href="{{ url('admin/paymentMethods') }}">
                             <i class="livicon" data-name="bank" data-size="18" data-c="#fff" data-hc="#fff" data-loop="true" ></i>
                            <span class="title">Payment Methods</span>
                            </a>
                            <a href="{{ url('admin/set_featuredprice') }}">
                             <i class="fa fa-angle-double-right"></i>
                            <span class="title">Payment set</span>
                            </a>
                             @endif
                </li>
                    </ul>
                ...
                <li>
                    ...
                    <ul class="sub-menu">
                        ...
                        <li class="active">
                            <a href="{{ url('admin/Citysubadress') }}">
                                <i class="livicon" data-name="vector-curve" data-size="18" data-c="#fff" data-hc="#fff" data-loop="true" ></i></i>
                                <span class="title"> City Subadress</span>
                            </a>
                        </li>
                        <li class="active">
                ...
                <li>
                    ...
                    <ul class="sub-menu collapse" aria-expanded="false" style="height: 1px;">
                        ...
                        <li>
                            <a href="{{ url('admin/siteLogo') }}">
                                <i class="fa fa-angle-double-right"></i>
                                Site Logo
                            </a>
                        </li>
                        <li>
                            <a href="{{ url('admin/view_banneroffer') }}">
                                <i class="fa fa-angle-double-right"></i>
                                All Banner Offer
                            </a>
                        </li>
                ...
                <!--                <li>
                                    <a href="{{ url('admin/inquire_propertyinfo') }}">
                                        <i class="livicon" data-name="location" data-size="18" data-c="#fff" data-hc="#fff" data-loop="true" ></i>
                                        <span class="title">Inquire Property </span>
                                    </a>
                                </li>-->
