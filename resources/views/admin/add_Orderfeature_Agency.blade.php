...
<aside class="right-side">
    ...
    <section class="content-header">
        <!--section starts-->
        <h1>Set Your Featured Agency</h1>
        <ol class="breadcrumb">
            <li>
            ...
            <li class="active">Add Agency Featured</li>
        </ol>
    </section>
        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form action="/admin/agency_FeatureOrderStore/" method="post" enctype="multipart/form-data" name="myform">
                        {!! csrf_field() !!}
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-3">
                                <input type="text" readonly class="form-control" value="{{$order}}" name="order_no">
                            </div>
                            <div class="col-md-2">
                                <label class="control-label">Adds Id</label>
                            </div>
                            <div class="col-md-3">
                                <input type="text" readonly class="form-control" value="{{$pro->id}}" name="user_id" >
                            </div>
                        </div>
                        <br><br><br>
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <input type="text" readonly class="form-control" value="{{$pro->DisplayName}}" name="agency_name" >
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                         ...
                         <div class="col-md-3">
                                <label for="featured_category">
                                    <input type="radio" id="featured_category" name="featured_category" value="1" onblur = "Multiple(this)" @if($pro->featured_category == '1' ) checked @endif >Feature HomePage</label>
                                <label for="example-radio2">
                                    <input type="radio" id="featured_category" name="featured_category" value="2" onblur = "Multiple(this)" @if($pro->featured_category == '2' ) checked @endif >Feature ListingPage</label>
                               </div>
<!--                            <div class="col-md-3">
                                <label for="featured_category">
