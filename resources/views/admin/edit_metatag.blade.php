...
<aside class="right-side">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Meta Tagging</li>
        </ol>
    </section>
    <!--section ends-->
            ...
            <div class='col-lg-12'>
                ...
                <div class='box well well-sm'>
                    ...
                    <div class='box-body pad'>
                        <form method="POST" action="{{ URL::action('MetatagController@update',['id' => $record]) }}">
                            {{ csrf_field() }}
                            <label>Description</label>
                            <textarea class="textarea editor-cls" placeholder="Place some Description here" value="" style="height:100px" id="description" name="description">{{ $record->description}}</textarea>
                            <br>
                            <label>Keywords</label>
                            <textarea class="textarea editor-cls" placeholder="Place some Keywords here" value="" style="height:100px" id="keywords" name="keywords">{{ $record->keywords}}</textarea>
                            <br>
                            <label>Title</label>
                            <input type="text" name="title" placeholder="Enter site title" class="form-control" value="{{$record->title}}"/>
                            <div class="row">
