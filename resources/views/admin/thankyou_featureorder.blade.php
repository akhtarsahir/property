        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                <div class="jumbotron text-center">
                    ...
                    <hr>
                    <p class="text-left">&nbsp; &nbsp; &nbsp; Order No: {{$last_order->order_id}} <br>&nbsp; &nbsp; &nbsp; Selected Category:@if($last_order->featured_category == '1' )
                                            Premium HomePage
                    ...
                    <p>After completion your payment process please verify from here or Order page:<br>&nbsp; &nbsp;&nbsp; &nbsp;<a class="btn btn-primary btn-sm" href="/admin/add_paymentTID/{{ $last_order->id }}" role="button">Verify Your Payment</a></p>
                </div>    
            </div>
        </div>
