                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-info">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <a href="/admin/addCitysubadress" class=" btn btn-primary btn-lg pull-right">Add New CitySub Address</a>
                            </div>
                        </div>
                        <div class="panel-body">
                            <table class="table table-striped table-bordered" id="citytable">
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $user['citysubaddress']; ?></td>
                                    <td><?php echo $user['latitude']; ?></td>
                                    <td><?php echo $user['longitude']; ?></td>
                                    <td>
                                        <a href="/admin/edit_citysubAddress/{{ $user['id'] }}" class="btn default btn-xs purple">
                                            <i class="fa fa-edit"></i>
                                            Edit
                                        </a>
                                    </td>
                                    <td>
                                        <a href="/admin/delete/{{$user->id}}" class="btn default btn-xs black">
