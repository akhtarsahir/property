...
<aside class="right-side">
    ...
    <section class="content-header">
        <!--section starts-->
        <h1>Property Cities Sub Address</h1>
        <ol class="breadcrumb">
            <li>
                <a href="dashboard">
            ...
            <li>
                <a href="{{ url('city/create') }}">Cities Sub Address</a>
            </li>
            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-info">
                    ...
                    <div class="panel-body">
                        ...
                        <form action="{{ url('admin/addCitysubadress') }}" method="post"  class="form-horizontal">
                            {!! csrf_field() !!}
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label > City Address Name  </label>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="@if($errors->first('cityname')) has-error @endif">
                                        ...
                                        <!--<input type="text" class="form-control"   name="citysubaddress" value="" placeholder="Enter address" required>-->
                                            <select  class="selectpicker form-control" name="cityname" id="cityname"  data-live-search="false" dat-live-search-style="begins" title="Select" required>
                                        <!--<option id="place-name"></option>-->
                                        @foreach($data as $city)
                                        <option class="{{ $city->latitude }},{{ $city->longitude }}" value="{{ $city->cityno }}" <?php if($city->name == '#cityname' ) selected ?> >{{ $city->name }}</option>
                                        @endforeach
                            ...
                            <div class="form-group">
                                <div class="col-sm-4">
                                    <button class="btn-success btn">Save Address</button>
...
//        var city_add = document.getElementById('city_address');
//        alert("ali".city_add);
