...
<aside class="right-side">
    ...
    <section class="content-header">
        <!--section starts-->
        <h1>Edit Your Transfer ID and Order No</h1>
        <ol class="breadcrumb">
            <li>
        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form action="/admin/update_paymentTID/" method="post" enctype="multipart/form-data" name="myform">
                        {!! csrf_field() !!}
                        <input id="id" type="hidden" name="id" value="{{ Auth::user()->id }}">
                        @foreach($payments as $pro)
                         <input id="id" type="hidden" name="payementorder_id" value="{{$pro->payementorder_id}}">
