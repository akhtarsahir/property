        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form action="/admin/agencyupdate_order/" method="post" enctype="multipart/form-data" name="myform">
                        {!! csrf_field() !!}
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-3">
                                <input type="text" readonly class="form-control" value="{{$pro->user_id}}" name="user_id" >
                            </div>
                        </div>
                        <br><br><br>
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <input type="text" readonly class="form-control" value="{{$pro->agency_name}}" name="agency_name" >
                            </div>
                        </div>
