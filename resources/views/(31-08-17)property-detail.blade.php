                                    ...
                                    <div class="slideshow">
                                        ...
                                        <div class="slideshow-nav-main">
                                            <div class="slideshow-nav">
                                                <div>
                                                    <img src="{{ asset('public/propetyImages/'.$singleproperty->id.'/750x388'.$singleproperty->image0)}}" style="width: 116px; height:90px;" alt="{{ $singleproperty->title }}">
                                                </div>
                                                @if($singleproperty->image1 != '')
                                                <div>
                                                    <img src="{{ asset('public/propetyImages/'.$singleproperty->id.'/750x388'.$singleproperty->image1)}}" style="width: 116px; height:90px;" alt="{{ $singleproperty->title }}">
                                                </div>
                                                @endif
                                                @if($singleproperty->image2 != '')
                                                <div>
                                                    <img src="{{ asset('public/propetyImages/'.$singleproperty->id.'/750x388'.$singleproperty->image2)}}" style="width: 116px; height:90px;" alt="{{ $singleproperty->title }}">
                                                </div>
                                                @endif
                                                @if($singleproperty->image3 != '')
                                                <div>
                                                    <img src="{{ asset('public/propetyImages/'.$singleproperty->id.'/750x388'.$singleproperty->image3)}}" style="width: 116px; height:90px;" alt="{{ $singleproperty->title }}">
                                                </div>
                                                @endif
                                                @if($singleproperty->image4 != '')
                                                <div>
                                                    <img src="{{ asset('public/propetyImages/'.$singleproperty->id.'/750x388'.$singleproperty->image4)}}" style="width: 116px; height:90px;" alt="{{ $singleproperty->title }}">
                                                </div>
                                                @endif
                                            </div>
                                        </div>
