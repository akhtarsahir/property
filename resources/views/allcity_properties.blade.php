                ...
                <div class="col-sm-12">
                    <div class="page-title-center">
                        <div class="col-sm-6 col-sm-offset-4">
                            ...
                            @endforeach
                            @if(!empty($url_value) )
                            <h2>All Properties For {{$value}} @if(!empty($total_result)){{$total_result}} Results Found @endif </h2>
                            @elseif(empty($url_value))
                            <h2>@if(!empty($value)){{$value}} @elseif(empty($value)) {{$purpose}} @endif @if(!empty($total_result)){{$total_result}} Results Found @endif </h2>
                            @endif
