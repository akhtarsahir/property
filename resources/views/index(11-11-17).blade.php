                                    ...
                                    <div class="figure-block">
                                        <figure class="item-thumb">
                                            <a href="{{ $add->webSite_url }}" class="hover-effect" target="_blank">
                                                <img src="{{ asset('AddsImages/'.$image)  }}" alt="{{ $property->title }}" width="194" height="143" >
                                            </a>
                                        </figure>
                                    </div>
                                </div>
                                    ...
                                    <div class="figure-block">
                                        <figure class="item-thumb">
                                            ...
                                            <div class="detail-above detail">
                                                <div class="fig-title">
                                                 <h3 style="font-size: 14px;">{!! str_limit("$property->title", 15) !!} <small  style="color: #5791ed;font-size: 15px;">{{ $property->city }}</small></h3>
                                                </div>
                                ...
                                <div class="item">
                                    <div class="figure-block">
                                        <figure class="item-thumb">
                                            ...
                                            <div class="detail-above detail">
                                                <div class="fig-title">
                                                <h4 style="font-size: 14px;">{!! str_limit("$property->title", 15) !!} <small  style="color: #5791ed;font-size: 15px;">{{ $property->city }}</small></h4>
                                                </div>
                                            </div>
                                        </figure>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <div id="properties-carouselll-6" class="carousel slide-animated">
                            ...
                            @foreach($leatest_Projects as $property)
                                <?php $image = '385x258'.$property->image0; ?>
                                <div class="item">
                                    <div class="figure-block">
                                        <figure class="item-thumb">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <div id="properties-carouselrent-6" class="carousel slide-animated">
                            ...
                            @foreach($leatest_Rentproperties as $property)
                                <?php $image = '385x258'.$property->image0; ?>
                                <div class="item">
                                    <div class="figure-block">
                                        <figure class="item-thumb">
