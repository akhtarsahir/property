...
<script>
    if (datefield.type != "date_text") { //if browser doesn't support input type="date", initialize date picker widget:
        jQuery(function ($) { //on document.ready
            $('#ConstructionYear').datepicker({maxDate: new Date(), dateFormat: 'dd/mm/yy'});
...
<section id="section-body">
    ...
    <div class="container" style="background-color: #999; background-image:  url('assets/images/texture.png');">
                        ...
                        <div class="add-tab-row push-padding-bottom">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-4 col-sm-offset-1">
                                    ...
                                    <div class="form-group">
                                        <label for="property-price" class="bold-class">Google Maps Longitude</label>
                                    ...
                                    <div class=form-group>
                                        <label for="property-price-before" class="bold-class">Google Maps Latitude</label>
                        ...
                        <div class="add-tab-row push-padding-bottom">
                            ...
                            <div class="col-sm-4">
                             ...
                             <div class="col-sm-6">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <select  class="selectpicker" id="CAarea_unit" name="CAarea_unit" data-live-search="false" data-live-search-style="begins" title="Select">
                                        <option value="Marla">Marla</option>
                                        <option value="Kanal">Kanal</option>
                                        <option value="acres">Acres</option>
                                        <option value="Square Yard">Square Yard</option>
                            ...
                            <div class="col-sm-4">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <select  class="selectpicker" id="OAarea_unit" name="OAarea_unit" data-live-search="false" data-live-search-style="begins" title="Select">
                                        <option value="Marla">Marla</option>
                                        <option value="Kanal">Kanal</option>
                                        <option value="acres">Acres</option>
                                        <option value="Square Yard">Square Yard</option>
                            ...
                            <div class="homeandcommercial hide" id="homeandcommercial">
                                <!--<div class="homeandcommercial" id="homeandcommercial">-->
                                <div class="add-title-tab">
                                    <h3>Measurement </h3>
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <div class="">
                                                                        ...
                                                                        <input type="file" name="pdf" class="btn btn-primary" value="" accept=".xlsx,.xls,image/*,.doc, .docx,.ppt, .pptx,.txt,.pdf" >
                                    ...
                                    <div class="row">
                                        <div class="control-group" id="fields">
                                            <label class="control-label" for="field1">
                                                if More than One image Upload Click <span class="glyphicon glyphicon-plus"></span> Button <br>
                                            ...
                                            <div class="controls">
                                                ...
                                                <div class="entry input-group col-xs-3">
                                                    ...
                                                    <input class="btn btn-primary"name="image[]"  accept="image/*" type="file" required id="image">
