...
class SearchController extends Controller
{
    ...
    public function  SearchFormData(Request $request)
    {
       ...
       if( $purpose != 'sell' && $purpose != 'rent'){ $purpose = '';  } 
       if( $subtype != 'Houses / Villas' && $subtype != 'Res. Plots /Files' && $subtype != 'Flats / Apartments'&& $subtype != 'Form Houses'&& $subtype != 'Upper Portion'&& $subtype != 'Lower Portion'&& $subtype != 'Commercial Plots /files'&& $subtype != 'Agricultural Land'&& $subtype != 'Industrial Land'&& $subtype != 'Offices'&& $subtype != 'Shops / Showrooms'&& $subtype != 'Warehouses / Godown'&& $subtype != 'Buildings / Plaza'&& $subtype != 'Factories/Workshops'&& $subtype != 'Guest House / Hostels'&& $subtype != 'Schools / Colleges'&& $subtype != 'Hotel / Restaurant'&& $subtype != 'Residental Towns / Scheeme'&& $subtype != 'Land Sub Divisions'&& $subtype != 'Commercial Plaza / Area'&& $subtype != 'Industrial Estate / Zone'){  $subtype = '';  }
